...
/*
	WARNING: There are some external changes in the header file.
	
	By using it, you may encounter problems that are not present
	in the original file. This file was specially customized for
	this repository:

	https://github.com/b5ysQoPl9xBhrYPt6/RM-AC
*/
...
#ifndef LIB_BASS_DYNAMIC_LOAD   // REDACTED: Added condition for dynamic library load
